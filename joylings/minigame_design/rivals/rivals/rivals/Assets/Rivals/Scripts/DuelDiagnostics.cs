...
namespace RivalsPrototype {
  public partial class DuelSession {
    ...
    [Serializable] class PlayerSnapshot {
      public int seat,team,health,weapon,owned,hits,pickups,ammo,shots,visualShots;public bool bot,reloading,nameVisible;public string name;
    ...
    [Serializable] class CombatSnapshot {
      public int maxHealth,phase,round,game,blueWins,redWins,winner,localSeat,targetSeat,tickRate;public Vector2 look;public bool controls,aiming,server;
